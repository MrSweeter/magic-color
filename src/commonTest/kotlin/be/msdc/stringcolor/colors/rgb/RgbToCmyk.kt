...
class RgbToCmyk {
    ...
    fun testToCmykBlack() {
        ...
        assertEquals(0, cmyk.cyan)
        assertEquals(0, cmyk.magenta)
        assertEquals(0, cmyk.yellow)
        assertEquals(100, cmyk.key)
    }
    ...
    fun testToCmykRed() {
        ...
        assertEquals(0, cmyk.cyan)
        assertEquals(100, cmyk.magenta)
        assertEquals(100, cmyk.yellow)
        assertEquals(0, cmyk.key)
    }
